              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                >
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                    {[
                      { name: 'Jeremy Zhang', username: 'JeremyZXi' },
                      { name: 'Eric Gao', username: 'Er1cG1ao' },
                      { name: 'Robert Liao', username: 'Jeremy-Pornhub' },
                      { name: 'Bobc Mei', username: 'BobcMei' },
                    ].map((contributor, i) => (
                        <a
                            key={i}
                        ...
                        >
                          <img
                              src={`https://img.shields.io/badge/GitHub-${contributor.username}-181717?logo=github&logoColor=white`}
                              alt={`${contributor.name}'s GitHub badge`}
                              className="h-8"
                          />
                        </a>
                    ))}
